<cfcomponent extends="algid.inc.resource.base.view" output="false">
	<cffunction name="filterActive" access="public" returntype="string" output="false">
		...
		<cfset filterActive.addBundle('plugins/documentation/i18n/inc/view', 'viewTransient') />
	...
	<cffunction name="filter" access="public" returntype="string" output="false">
		...
		<!--- Add the resource bundle for the view --->
		<cfset filter.addBundle('plugins/documentation/i18n/inc/view', 'viewTransient') />
	...
	<cffunction name="datagrid" access="public" returntype="string" output="false">
		...
		<!--- Add the resource bundle for the view --->
		<cfset datagrid.addBundle('plugins/documentation/i18n/inc/view', 'viewTransient') />
